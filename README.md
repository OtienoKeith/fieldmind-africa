...
The repository also includes a **[2-minute 18-second final narrated demo](video/fieldmind-africa-final-demo.mp4)** built entirely with local/free tooling. It shows the trained Q5 deployment, English/Kiswahili decisions, chemical-dose guard, evidence-backed diagnosis and reproducible pipeline.
